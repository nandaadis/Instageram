...
import com.example.instageram.databinding.FragmentFollowingDetailBinding
 ...
 * Use the [FollowingDetailFragment.newInstance] factory method to
...
class FollowingDetailFragment : Fragment() {
    ...
    private var _binding: FragmentFollowingDetailBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFollowingDetailBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = FollowingDetailAdapter(
            viewModel,
            viewLifecycleOwner,
            view,
            viewModel.FollowingListConfig(this, userid!!),
    ...
    companion object {
         ...
         * @return A new instance of fragment FollowingDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FollowingDetailFragment().apply {
